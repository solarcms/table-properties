...
export default class Body extends Component {
    ...
    render() {
        ...
        const gridHeader = bodyHeader.map((grid, index) => {
            ...
            return <th key={index} data-field={grid.column} tooltip={grid.title} className="sorting">{grid.title}</th>
        })
        ...
        return (<div id="gridBody" className="m-a-sm ">
            <div className="white with-3d-shadow">
                ...
                <table id="tp-table" className="bootstrapTable"
                ...
                >
                    <thead>
                    <tr>
                        <th style={{width: '25px'}} data-field="index"><b>№</b></th>
                        {gridHeader}
                        <th style={{textAlign: 'center'}} data-field="actions"><i className="fa fa-ellipsis-h"></i></th>
                    </tr>
                    </thead>
                    <tbody>
                    { showInlineForm === 'eeeeeee' ? inlineAddForm : null}
                    { gridData }
